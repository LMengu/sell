...
CREATE TABLE `hos_sales` (
  ...
  PRIMARY KEY (`hospital_id`,`salesman_id`),
  KEY `salesman_id` (`salesman_id`),
  CONSTRAINT `hos_sales_ibfk_1` FOREIGN KEY (`hospital_id`) REFERENCES `hospital` (`id`),
  CONSTRAINT `hos_sales_ibfk_2` FOREIGN KEY (`salesman_id`) REFERENCES `salesman` (`id`)
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES ('1', '六味地黄丸', '滋阴补肾', '268', '2');
INSERT INTO `order` VALUES ('2', '藿香正气液', '用于外感风寒', '30', '3');
