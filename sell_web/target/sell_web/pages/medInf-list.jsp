dd<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/medInfs/findAll.do">药品信息管理</a></li>
						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${MedInfList}" var="medinf">
										<tr>
											<td><input name="ids" type="checkbox"></td>
											<td>${medinf.id }</td>
											<td>${medinf.medName }</td>
											<td>${medinf.productionDateStr}</td>
